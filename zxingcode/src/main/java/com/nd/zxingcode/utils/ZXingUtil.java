...
public class ZXingUtil {
    ...
    public static Bitmap createQRCodeWithLogo(String text, Bitmap bitmap) {
        return createQRCodeWithLogo(text, 500, 0.25f, bitmap);
    }
     ...
     * @param logoSizeRate 生成的logo图片大小占比
     * @param bitmap       logo文件
     * @return bitmap
     */
    public static Bitmap createQRCodeWithLogo(String text, int size, float logoSizeRate, Bitmap bitmap) {
        try {
            ...
            Bitmap bitmapRet = Bitmap.createBitmap(size, size,
                    Bitmap.Config.ARGB_8888);
            bitmapRet.setPixels(pixels, 0, size, 0, 0, size, size);
            return bitmapRet;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
